# text_extractor.py - Advanced text snippet extraction with contextual analysis
...
from vector_engine import embed_with_context

@dataclass
class ContextualSnippet:
    """
    Data class representing a contextual text snippet with metadata.
    Contains the snippet text along with its context and scoring information.
    """
    text: str
    context_before: str
    context_after: str
...
class ContextualEmbeddingEngine:
    """
    Engine for creating contextual embeddings that consider surrounding text.
    This class handles the creation of embeddings that incorporate context information.
    """
    ...
    def create_contextual_embedding(self, sentence: str, context: str, persona: str, job_to_be_done: str) -> np.ndarray:
        """
        Create a contextual embedding by combining sentence and context embeddings.
        
        Args:
            sentence: The target sentence to embed
            context: Surrounding context text
            persona: User persona/role
            job_to_be_done: Task description
            
        Returns:
            Combined contextual embedding as numpy array
        """
...
class AdvancedTextExtractor:
    """
    Advanced text snippet extractor that uses contextual analysis and MMR selection.
    This class implements sophisticated text extraction with diversity considerations.
    """
    def __init__(self, 
    ...
    def advanced_sentence_cleaning(self, text: str, header: str) -> List[str]:
        """
        Clean and filter sentences based on quality criteria.
        
        Args:
            text: Raw text to process
            header: Section header to exclude
            
        Returns:
            List of cleaned, quality sentences
        """
