# document_parser.py - Advanced PDF document parsing and section extraction
"""
...
class AdvancedDocumentParser:
    ...
    This class implements sophisticated document parsing with multiple extraction
    strategies and comprehensive logging capabilities.
    """
    ...
    def __init__(self, output_file: str = "checking.json"):
        ...
        # Tuning parameters for document parsing
...
def process_pdf_to_json(pdf_path: str, output_file: str = "checking.json") -> Dict:
    ...
    """
    processor = AdvancedDocumentParser(output_file)
...
def extract_sections_from_pdf(pdf_path: str) -> List[Dict]:
    ...
    """
    processor = AdvancedDocumentParser()
